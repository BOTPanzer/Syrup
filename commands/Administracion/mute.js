...
if(tomute.roles.some(r=>[serverconfig[message.guild.id].mods].includes(r.name))) {
  return message.reply("El miembro es **moderador** y no se puede mutear.");
}
//#BEBEBE
let modPosition = message.guild.roles.find("name", serverconfig[message.guild.id].mods).position
